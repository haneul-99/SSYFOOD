...
<!-- 				<li onclick="location.href='/ssy/member/memberpage2.do';"><span>장바구니<br>페이지</span></li>
				<li onclick="location.href='/ssy/member/memberpage3.do';" style="background-color:#ccc"><span>찜목록</span></li> -->
		...
		<div id="my">
			...
			<table>
				...
				<tr>
					...
					<td><input type="button" onclick="location.href='#'" value="상품 자세히 보기"></td>
				</tr>
				<% n=n+1; %>
				</c:forEach>
			</table>
