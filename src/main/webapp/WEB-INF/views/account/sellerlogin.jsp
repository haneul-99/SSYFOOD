...
<body>
	...
	<main>
		<form method="POST" action="/ssy/account/sellerloginok.do">
			<div class="head">
			<span>판매자 로그인</span>
            ...
            <div class="find">
            	<a href="/ssy/account/findid.do" class="find-font">아이디 찾기</a>
				<span>|</span>
		...
		<!— 테스트용 판매자 아이디 접속 —>
		<form method="POST" action="/ssy/account/sellerloginok.do">
			<input type="hidden" name="id" value="sDLRhI3">
			<input type="hidden" name="pw" value="oknrkdey65">
			<input type="submit" value="테스트셀러로그인">
		</form>
