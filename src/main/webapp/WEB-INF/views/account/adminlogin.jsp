...
<body>
	...
	<main>
		<form method="POST" action="/ssy/account/adminloginok.do">
			<div class="head">
			<span>관리자 로그인</span>
            	...
            	<div id="idForm" class="form1">
           		<div>아이디</div>
                  	...
                  	placeholder="아이디 입력" required></input></div>
            	</div>
            	<div id="pwForm" class="form1">
            	<div>비밀번호</div>
            	<div>   
            	<input type="password" class="txt" id="pw" name="pw"
                  placeholder="비밀번호 입력" required></input></div>
            </div>
	        <div class="find">
		...
		<!-- 테스트용 관리자 아이디 접속 -->
		<form method="POST" action="/ssy/account/adminloginok.do">
			<input type="hidden" name="id" value="eee">
			<input type="hidden" name="pw" value="1111">
			<input type="submit" value="테스트어드민로그인">
		</form>
