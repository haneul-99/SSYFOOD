 ...
 * 
 * @author 김하늘
 * <p>관리자가 문의게시판에 답변을 추가할 때 사용하는 클래스입니다.</p>
 * 
 */

@WebServlet("/complainboard/cpcommentadd.do")
public class CpCommentAdd extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/board/cpcommentadd.jsp");
