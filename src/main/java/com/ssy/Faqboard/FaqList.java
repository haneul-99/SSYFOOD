 ...
 * 
 * @author 김하늘
 * <p>자주하는 질문게시판 목록을 보여주는 클래스입니다.</p>
 *
 */

@WebServlet("/faqboard/faqlist.do")
public class FaqList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	    ...
	    ArrayList<FaqDTO> list = dao.list(map);
	        
	    for (FaqDTO dto : list) {

	        String fqdate = dto.getFqdate();
	        
	        fqdate = fqdate.substring(0, 10);
	        
	        dto.setFqdate(fqdate);
	        ...
	        if (isSearch.equals("y") && column.equals("fqtitle")) {
	           
	          
	          fqtitle = fqtitle.replace(word, "<span style=\"background-color: #F7FF43;\">" + word + "</span>");
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/board/faqlist.jsp");
